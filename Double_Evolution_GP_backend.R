...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
single_strategy_decision <- function(dataframe, rule, period, log_return, 
                                     principal        = GP_hyperparam[['principal size']], 
                                     transaction_cost = GP_hyperparam[['transaction cost']]){
...
strategy_combiner <- function(dataframe, strategies, period, log_return, 
                              principal        = GP_hyperparam[['principal size']], 
                              transaction_cost = GP_hyperparam[['transaction cost']]) {
  
  num_strategy = length(strategies)
  individual_decision = single_strategy_decision(dataframe,strategies[[1]], period, log_return)
  
  for (i in 2:num_strategy) {
